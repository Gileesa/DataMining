...
# Original dataset
DATASET_ORIGIN = 'csv_files/dataset_mood_smartphone.csv'                     
...
WINDOW_DATASET_PATH = "csv_files/KNN/KNN_one_size_mood_window_dataset.csv"
TRAIN_PATH = "csv_files/KNN/mood_train.csv"
TEST_PATH = "csv_files/KNN/mood_test.csv"
